...
import com.linggong.entity.VoucherOrder;
import com.linggong.mapper.VoucherOrderMapper;
import com.linggong.service.ISeckillVoucherService;
import com.linggong.service.IVoucherOrderService;
        ...
        public void run() {
            while (true) {
                try {
                    ...
                    LettuceConnectionValidTask.task();
                    log.error("处理订单异常", e);
                    handlePendingList();
                }
            }
...
@Component
@Slf4j
class LettuceConnectionValidTask {
    @Autowired
